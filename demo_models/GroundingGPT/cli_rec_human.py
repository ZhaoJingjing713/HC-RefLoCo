...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_dir", type=str, default="/home/v-jinjzhao/datasets/rec_human_celeb_ready/images_v2/val_ready")
    parser.add_argument("--json_path", type=str, default='/home/v-jinjzhao/datasets/rec_human_celeb_ready/person_annts_val_ready.json')
