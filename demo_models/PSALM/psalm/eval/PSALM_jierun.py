...
class DataArguments:
    ...
    image_folder: Optional[str] = field(default='/home/v-jinjzhao/datasets/jierun/images')
    model_path: Optional[str] = field(default="ckpt/PSALM")
    mask_config: Optional[str] = field(default="./psalm/mask_config/maskformer2_swin_base_384_bs16_50ep.yaml")
    image_aspect_ratio: str = 'square'
    image_grid_pinpoints: Optional[str] = field(default=None)
    json_path: str = '/home/v-jinjzhao/datasets/jierun/ref_msra_test_coco_o365.json'
    model_map_name: str = 'psalm'
    version: str = 'llava_phi'
    output_dir: str = './output_jierun/'
...
def evaluation():
    ...
    with torch.no_grad():
        for idx, inputs in tqdm(enumerate(eval_dataloader), total=len(eval_dataloader)):
            ...
            pred_file.write(json.dumps({'ann_id': inputs['seg_info'][0]['ann_id'], 'bbox':bbox_list})+'\n')
            pred_file.flush()
