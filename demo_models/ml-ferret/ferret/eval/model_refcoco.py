...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_path", type=str, default="/home/v-jinjzhao/dev/datasets/coco2014/train2014")
    parser.add_argument("--data_path", type=str, default="/home/v-jinjzhao/dev/datasets/coco2014/finetune_refcoco_val.json")
    parser.add_argument("--answers-file", type=str, default="refexp_result/refcoco_val")
